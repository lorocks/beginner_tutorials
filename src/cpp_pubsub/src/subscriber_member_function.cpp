 ...
 * @author Lowell Lobo
 * @brief A minimal subscriber node for ros2 that posts the messages received in topic "/topic"
 * @version 0.1
 * @date 2023-11-07
 * 
...
/**
 * @brief MinimalSubscriber class that inherits form the Node class in rclcpp used to built a ros2 node
 * 
 */
class MinimalSubscriber : public rclcpp::Node {
  ...
  */
  ...
  /**
   * @brief Create a subscriber shared pointer from rclcpp to be used in the implementation
   * 
   */
